...
class PCBuilder:
    ...
    def build(self, verbose: bool = False, clean: bool = False) -> bool:
        ...
        compile_steps = [
            ...
            ("application core", "src/main/java/com/excudo/core/inspection/*.java src/main/java/com/excudo/core/introspection/*.java src/main/java/com/excudo/core/synthesis/*.java src/main/java/com/excudo/core/synthesis/spec/*.java src/main/java/com/excudo/core/orchestration/*.java src/main/java/com/excudo/core/commands/*.java src/main/java/com/excudo/core/llm/*.java src/main/java/com/excudo/mcp/*.java src/main/java/com/excudo/mcp/config/*.java src/main/java/com/excudo/console/*.java src/main/java/com/excudo/console/utils/*.java src/main/java/com/excudo/cli/*.java"),
        ]
